...
import type { Mitarbeiter, Schichtvorlagen, Schichtplan } from '@/types/app';
...
const MITARBEITER_FIELDS = [
  ...
  { key: 'bemerkung', label: 'Bemerkungen', type: 'string/textarea' },
];
const SCHICHTVORLAGEN_FIELDS = [
  { key: 'schichtname', label: 'Schichtname', type: 'string/text' },
  { key: 'schichttyp', label: 'Schichttyp', type: 'lookup/select', options: [{ key: 'fruehschicht', label: 'Frühschicht' }, { key: 'spaetschicht', label: 'Spätschicht' }, { key: 'nachtschicht', label: 'Nachtschicht' }, { key: 'tagschicht', label: 'Tagschicht' }, { key: 'sonderschicht', label: 'Sonderschicht' }] },
  { key: 'startzeit', label: 'Startzeit', type: 'string/text' },
  { key: 'endzeit', label: 'Endzeit', type: 'string/text' },
  { key: 'bereich', label: 'Bereich / Abteilung', type: 'string/text' },
  { key: 'mindestbesetzung', label: 'Mindestbesetzung (Personen)', type: 'number' },
  { key: 'beschreibung', label: 'Beschreibung', type: 'string/textarea' },
];
const SCHICHTPLAN_FIELDS = [
  { key: 'datum', label: 'Einsatzdatum', type: 'date/date' },
  ...
  { key: 'status', label: 'Status', type: 'lookup/select', options: [{ key: 'geplant', label: 'Geplant' }, { key: 'bestaetigt', label: 'Bestätigt' }, { key: 'abwesend', label: 'Abwesend' }, { key: 'vertreten', label: 'Vertreten' }] },
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'schichtplan' && fieldKey === 'schichtvorlage') {
