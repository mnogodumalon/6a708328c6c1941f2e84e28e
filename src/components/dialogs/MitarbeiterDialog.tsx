...
export function MitarbeiterDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: MitarbeiterDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'bemerkung': (
      <div key="bemerkung" className="space-y-1.5">
        <Label htmlFor="bemerkung">Bemerkungen</Label>
        <Textarea
          id="bemerkung"
          placeholder=""
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "telefon": "Telefonnummer", "email": "E-Mail-Adresse", "abteilung": "Abteilung", "position": "Position / Rolle", "beschaeftigungsart": "Beschäftigungsart", "bemerkung": "Bemerkungen"};
