...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/schichtplanung', label: 'Schicht einplanen', icon: IconCalendarPlus, description: 'Mitarbeiter für eine Schicht einplanen' },
  { path: '/intents/schicht-status', label: 'Schichtstatus pflegen', icon: IconClipboardCheck, description: 'Schichtstatus für Mitarbeiter aktualisieren' },
  // </custom:intents>
];
