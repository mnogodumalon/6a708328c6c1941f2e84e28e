// Auto-generated. Per-entity form-enhancements config for "Schichtvorlagen".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'schichttyp': { kind: 'lookup', key: 'fruehschicht', label: 'Frühschicht' },
    'mindestbesetzung': { kind: 'literal', value: 1 },
  },
  computed: {},
};
